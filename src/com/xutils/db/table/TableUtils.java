...
import com.support.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.xutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.xutils.db.table.Id>();

    /* package */
    static synchronized com.xutils.db.table.Id getId(Class<?> entityType) {
        ...
        com.xutils.db.table.Id id = new com.xutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.xutils.db.table.Id id = getId(entityType);
