...
public class PauseOnScrollListener implements OnScrollListener {
     ...
     * Constructor
     *
     * @param taskHandler   {@linkplain ImageViewUtils} instance for controlling
     * @param pauseOnScroll Whether {@linkplain ImageViewUtils#pause() pause loading} during touch scrolling
     * @param pauseOnFling  Whether {@linkplain ImageViewUtils#pause() pause loading} during fling
     */
