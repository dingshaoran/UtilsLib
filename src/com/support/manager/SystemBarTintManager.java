...
public class SystemBarTintManager {
	...
	/**
	 * 第一步tintManager.setStatusBarTintEnabled(true);
	 * 第二步tintManager.setStatusBarTintColor(0xffff0000);
	 * 第三步把value14和value19中theme:NoActionBar/HasActionBar设置给activity
	 */
	@TargetApi(19)
