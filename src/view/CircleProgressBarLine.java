 ...
 * @since 05.03.2013
 */
public class CircleProgressBarLine extends View {
	 ...
	 *            the context
	 */
	public CircleProgressBarLine(final Context context) {
		this(context, null);
	}
	 ...
	 *            the attrs
	 */
	public CircleProgressBarLine(final Context context, final AttributeSet attrs) {
	 ...
	 *            the def style
	 */
	public CircleProgressBarLine(final Context context, final AttributeSet attrs, final int defStyle) {
		super(context, attrs, defStyle);

		// load the styled attributes and set their properties
		final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.CircleProgressBarLine, defStyle, 0);
		if (attributes != null) {
			try {
				setProgressColor(attributes.getColor(R.styleable.CircleProgressBarLine_progress_color, Color.CYAN));
				setProgressBackgroundColor(attributes.getColor(R.styleable.CircleProgressBarLine_progress_background_color, Color.GREEN));
				setProgress(attributes.getFloat(R.styleable.CircleProgressBarLine_progress, 0.0f));
				setMarkerProgress(attributes.getFloat(R.styleable.CircleProgressBarLine_marker_progress, 0.0f));
				setWheelSize((int) attributes.getDimension(R.styleable.CircleProgressBarLine_stroke_width, 10));
				setThumbEnabled(attributes.getBoolean(R.styleable.CircleProgressBarLine_thumb_visible, true));
				setMarkerEnabled(attributes.getBoolean(R.styleable.CircleProgressBarLine_marker_visible, true));
				mGravity = attributes.getInt(R.styleable.CircleProgressBarLine_android_gravity, Gravity.CENTER);
			} finally {
